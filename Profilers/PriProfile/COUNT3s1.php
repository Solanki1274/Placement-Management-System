                ...
                <table class="table table-striped table-bordered templatemo-user-table" id="studentTable">
                    <thead>
                        <tr>
                            ...
                            <th><a class="white-text templatemo-sort-by" onclick="sortTable(12)">History Of Backlogs</a></th>
                            <th><a class="white-text templatemo-sort-by" onclick="sortTable(13)">Detain Years</a></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
