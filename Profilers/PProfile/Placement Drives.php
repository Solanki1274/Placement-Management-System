        ...
        <div class="templatemo-content-widget white-bg">
          <div class="templatemo-flex-row flex-content-row">
            <div class="col-1">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="Placement Drives/addpdrive.php">
                      <img class="media-object img-circle" src="images/sunset11.png" alt="Sunset" width="100px"
                        height="100px">
                    </a>
                  </div>
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="Placement Drives/update.php">
                      <img class="media-object img-circle" src="images/UD.png" alt="Sunset" width="100px"
                        height="100px">
                    </a>
                  </div>
                  <div class="media-body">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="Placement Drives/Companydetails.php">
                      <img class="media-object img-circle" src="images/sunset33.jpg" alt="Sunset" width="100px"
                        height="100px">
                    </a>
                  </div>
                  <div class="media-body">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="Placement Drives/drivehome.php">
                      <img class="media-object img-circle" src="images/DD.jpg" alt="Sunset" width="100px"
                        height="100px">
                    </a>
                  </div>
                  <div class="media-body">
              ...
              <div class="templatemo-content-widget orangge-bg">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="Placement Drives/viewapp.php">
                      <img class="media-object img-circle" src="images/AP.png" alt="Sunset" width="100px"
                        height="100px">
                    </a>
                  </div>
                  <div class="media-body">
                      <h2 class="media-heading text-uppercase">View Appications</h2>
                      <p>View Student Appications & Schedule Interview</p>
                  </div>
                  </a>
                </div>
              </div>
          ...
          <footer class="text-right">
            <p>Copyright &copy;2024 Hmc-PMS
              | Designed by <a href="#" target="_parent">Hmc FutureTechnologies</a></p>
          </footer>
        </div>
      </div>
    </div>
