            ...
            <div class="panel panel-default table-responsive">
                <table class="table table-striped table-bordered templatemo-user-table">
                    ...
                    <tbody>
                        ...
                        if (isset($_POST['s4'])) { 
                            $Cbranch = $conn->real_escape_string($_POST['cbranch']);
                            $RESULT = $conn->query("SELECT count(*) AS count FROM basicdetails WHERE `Approve`='1' AND Branch='$Cbranch'");
                            ...
                            $sql = $conn->query("SELECT * FROM basicdetails WHERE `Approve`='1' AND Branch='$Cbranch' ORDER BY Sem");
