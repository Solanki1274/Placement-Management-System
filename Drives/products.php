	...
	<div class="products-top">
		...
		<div class="container">
			<h3 class="wow fadeInRight animated" data-wow-delay="0.4s"
				style="visibility: visible; -webkit-animation-delay: 0.4s;">On Going and Upcomming Drives</h3>
			<h5 class="wow fadeInRight animated" data-wow-delay="0.4s"
				style="visibility: visible; -webkit-animation-delay: 0.4s;">Cras porttitor imperdiet volutpat nulla
				malesuada lectus eros
			...
			<section id="testimonials" class="testimonials-section">
				...
				<div class="slider-container">
					<div class="slider">
						<div class="card">
							<img src="Drives/images/company/ibm.png" alt="Company 1">
						</div>
						<div class="card">
							<img src="Drives/images/company/apple.png" alt="Company 2">
						</div>
						<div class="card">
			...
			<div class="copyright">
				...
				<div class="container">
					<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s"
						style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<p>Copyright &copy; 2015 Hmc-PMS | Developed by
							<a href="" target="_parent">ZNumerique Technologies</a>
					</div>
...
<script rel="script" href="js/slider.js"></script>
